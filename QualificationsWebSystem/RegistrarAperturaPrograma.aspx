<%@ Page Title="" Language="C#" MasterPageFile="~/MPAdministrator.Master" AutoEventWireup="true" CodeBehind="RegistrarAperturaPrograma.aspx.cs" Inherits="QualificationsWebSystem.RegistrarAperturaPrograma" %>
...
<p>
    ...
    <asp:Label ID="Label3" runat="server" 
        ...
        Text="APERTURAR PROGRAMAS DE POSTGRADO"></asp:Label>
</p>
<p>
    &nbsp;</p>
<p>
...
<p>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ConnectionString="<%$ ConnectionStrings:QualificationsDBConnectionString3 %>" 
        SelectCommand="SELECT [ProgramVersion] FROM [Version] ORDER BY [ID]"></asp:SqlDataSource>
&nbsp;
    </p>
<p>
    &nbsp;</p>
...
<p>
    <asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
        style="font-weight: 700" Text="APERTURAR PROGRAMA" Height="28px" 
        Width="300px" />
</p>
<p>
    &nbsp;</p>

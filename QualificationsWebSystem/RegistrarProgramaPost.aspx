<%@ Page Title="" Language="C#" MasterPageFile="~/MPAdministrator.Master" AutoEventWireup="true" CodeBehind="RegistrarProgramaPost.aspx.cs" Inherits="QualificationsWebSystem.RegistrarProgramaPost" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <br />
    <asp:Label ID="Label3" runat="server" Text="REGISTRAR PROGRAMA DE POSTGRADO" 
...
<br />
<br />
<asp:Button ID="Button1" runat="server" Height="32px" Text="REGISTRAR PROGRAMA" 
    Width="420px" 
